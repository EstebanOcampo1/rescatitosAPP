    ...
    return (
        <div className='miHtml'>
            <div style={{margin:'0 0 10px 10px'}}>
                <h6 className=' titulo' style={{ fontWeight: 400, fontFamily: 'moz-initial', backgroundColor: 'FFFFFFF', left: 30 ,display:'inline'}}>Powered By: Dazapi y Esteban Ocampo</h6><h6 className='col-5 titulo' style={{ fontWeight: 400, fontFamily: 'moz-initial', backgroundColor: 'FFFFFFF', justifyContent: 'center' ,display:'inline', float:'right'}}>Codigo completo en Github</h6>
            </div>
